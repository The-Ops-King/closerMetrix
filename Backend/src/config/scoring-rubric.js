...
module.exports = {
  ...
  scoreTypes: [
    { key: 'pitch_adherence_score',     label: 'Pitch',              description: 'How effectively the closer presented the offer' },
    { key: 'close_adherence_score',     label: 'Close Attempt',      description: 'How well the closer asked for the sale' },
    { key: 'objection_adherence_score', label: 'Objection Handling', description: 'How well objections were addressed and overcome' },
