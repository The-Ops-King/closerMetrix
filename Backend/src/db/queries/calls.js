...
const CALL_COLS_ARRAY = [
  ...
  'attendance', 'call_outcome', 'revenue_generated',
  'payment_plan', 'lost_reason', 'call_source', 'call_type',
  'objections', 'objections_json',
  'client', 'closer', 'date_closed', 'product_purchased',
  'call_url', 'transcript_status', 'transcript_provider', 'transcript_link', 'recording_url',
  'overall_call_score', 'script_adherence_score',
  ...
  'prospect_temperature', 'buying_signals',
  'ai_summary', 'ai_feedback', 'key_moments',
  'compliance_flags',
  'cash_collected', 'initial_cash_collected', 'total_payment_amount',
  'close_amount',
  'processing_status', 'processing_error', 'ingestion_source',
  'duration_minutes', 'source', 'timezone',
  'created', 'last_modified',
  'follow_up_scheduled', 'follow_up_date',
];
